...
class SkinLesionDataset(Dataset):
    ...
    def one_hot_encoding(self):
        ...
        # OneHotEncoder
        if os.path.exists("./src/results/preprocess_data/ohe_isic2020.pickle"):
            with open('./src/results/preprocess_data/ohe_isic2020.pickle', 'rb') as f:
                ohe = pickle.load(f)
            ...
            with open('./src/results/preprocess_data/ohe_isic2020.pickle', 'wb') as f:
                pickle.dump(ohe, f)

        # StandardScaler
        if os.path.exists("./src/results/preprocess_data/scaler_isic2020.pickle"):
            with open('./src/results/preprocess_data/scaler_isic2020.pickle', 'rb') as f:
            ...
            with open('./src/results/preprocess_data/scaler_isic2020.pickle', 'wb') as f:
        ...
        if os.path.exists("./src/results/preprocess_data/label_encoder_isic2020.pickle"):
            with open('./src/results/preprocess_data/label_encoder_isic2020.pickle', 'rb') as f:
                label_encoder = pickle.load(f)
            encoded_labels = label_encoder.transform(labels)
        else:
            label_encoder = LabelEncoder()
            encoded_labels = label_encoder.fit_transform(labels)
            with open('./src/results/preprocess_data/label_encoder_isic2020.pickle', 'wb') as f:
